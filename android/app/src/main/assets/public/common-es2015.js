...
let LocationPickerComponent = class LocationPickerComponent {
    ...
    getAddress(lat, lng) {
        return this.http
            .get(`https://maps.googleapis.com/maps/api/geocode/json?latlng=${lat},${lng}&key=${_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].googleMapsAPIKey}`).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(geoData => {

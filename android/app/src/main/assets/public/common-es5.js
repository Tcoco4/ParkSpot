    ...
    var LocationPickerComponent = /*#__PURE__*/function () {
      ...
      _createClass(LocationPickerComponent, [{
        ...
        value: function onPickLocation() {
          ...
          this.modalCtrl.create({
            ...
            modalEl.onDidDismiss().then(function (modalData) {
              if (!modalData.data) {
                // this is not set/selected
                return;
              }

              _this.getAddress(modalData.data.lat, modalData.data.lng).subscribe(function (address) {
                console.log(address);
              });
        ...
        value: function getAddress(lat, lng) {
          return this.http.get("https://maps.googleapis.com/maps/api/geocode/json?latlng=".concat(lat, ",").concat(lng, "&key=").concat(_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].googleMapsAPIKey)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (geoData) {
